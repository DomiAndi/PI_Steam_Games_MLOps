...
gasto_por_usuario= pd.read_parquet("Datasets/df_gasto_por_usuario.parquet")
item_por_usuario = pd.read_parquet("Datasets/df_item_por_usuario.parquet")

recommend = pd.read_parquet("Datasets/recommend.parquet")
user_reviews = pd.read_parquet("Datasets/reviews.parquet")

usuario_mas_horas = pd.read_parquet("Datasets/df_funcion2_A.parquet")
tiempo_por_anio = pd.read_parquet("Datasets/df_funcion2_B.parquet")

df_funcion3 = pd.read_parquet("Datasets/df_funcion3.parquet")
df_funcion4 = pd.read_parquet("Datasets/df_funcion4.parquet")
df_funcion5 = pd.read_parquet("Datasets/df_funcion5.parquet")

modelo_item = pd.read_parquet("Datasets/modelo_item.parquet")
